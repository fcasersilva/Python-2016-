...
###############################################################################
# Para a função t**2 de 0 até pi em senos ou cossenos
#def f1(t,n):
#    return t**2
#def f2(t,n):
#    return (t**2)*cos(n*t)
...
fsin=True         #True para uma série apenas de senos
fcos=False        #True para uma série apenas de cossenos
desloc=True       #True se a0 for claramente zero
###############################################################################
